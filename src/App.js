...
function App() {
  ...
  const [Movies, setMovies] = useState([
    ...
    },
    {
      ...
      rating: 4,
      trailerurl:'https://www.youtube.com/embed/5MBjAN7jqsQ'
    },
    {
      id:3,
      name: "Circle",
      ...
      rating: 2,
      trailerurl:'https://www.youtube.com/embed/JAlpm2oRzy8'
    },
    {
      id:4,
      name: "Inception",
    ...
    },
    {
      ...
      rating: 1,
      trailerurl:'https://www.youtube.com/embed/2Rxoz13Bthc'
    },
    {
      id:7,
      name: "The Godfather",
    ...
    },
    {
      ...
      rating: 4,
      trailerurl:'https://www.youtube.com/embed/XMnPKVbgH60'
    },
    {
      id:12,
      name: "Dachra",
      ...
      rating: 5,
      trailerurl:'https://www.youtube.com/embed/a5_WTF7KtYQ'
    },
    {
      id:13,
      name: "Paper Lives",
      ...
      rating: 2,
      trailerurl:'https://www.youtube.com/embed/lXdSaVK-vzs'
    },
    {
      id:14,
      name: "Seaspiracy",
      ...
      rating: 5,
      trailerurl:'https://www.youtube.com/embed/1Q5CXN7soQg'
    },
    ]);
    ...
    return (
      <div className="App">
        <BrowserRouter>
          <Navs/>
          <Switch>
            <Route path="/" exact><MoviesList Movies={Movies}/></Route>
            <Route path="/add" exact><AddMovie MoviesList={Movies} setMovies={setMovies}/></Route>
            <Route path='/description/:id'><Description Movies={Movies} /></Route>
          </Switch>
          <Footer/>
        </BrowserRouter>
      </div>
